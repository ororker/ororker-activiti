...
public class MultiInstanceTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources = { "org/activiti/engine/test/bpmn/multiinstance/MultiInstanceTest.testSequentialMultiSubprocessCollection.bpmn20.xml" })
  public void testSequentialMultiSubprocessCollection() {
	Collection<String> collection = new ArrayList<String>();
	collection.add("xxxxxxxxxxxxxxxxxxxxxyyyyyyyyyyyyyyyyyyyyyyyy\n");
	collection.add("wwwwwwwwwwwwwwwwwwwwwzzzzzzzzzzzzzzzzzzzzzzzz\n");
    Map<String, Object> variableMap = new HashMap<String, Object>();
    variableMap.put("collection", collection);
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testSequentialSubProcessEmptyCollection", variableMap);
    assertNotNull(processInstance);
